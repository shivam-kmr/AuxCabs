...
public class Welcome extends FragmentActivity implements LocationListener,OnMapReadyCallback, RoutingListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Intent intent = new Intent(Welcome.this, DriverSettingsActivity.class);
                // startActivity(intent);
                return;
            }
        });
        mHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Intent intent = new Intent(Welcome.this, HistoryActivity.class);
